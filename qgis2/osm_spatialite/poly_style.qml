...
<qgis version="2.4.0-Chugiak" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules>
      ...
      <rule filter="&quot;amenity&quot;='parking'" symbol="1" label="parking"/>
      <rule filter="&quot;landuse&quot; = 'forest' or &quot;leisure&quot; = 'park' OR &quot;natural&quot; = 'wood' OR &quot;leisure&quot; = 'nature_reserve' OR &quot;natural&quot; = 'wetland'" symbol="2" label="forest &amp; park"/>
      <rule filter=" &quot;aeroway&quot; is not null or &quot;landuse&quot; = 'industrial'" symbol="3" label="industrial"/>
      <rule filter="&quot;landuse&quot; = 'residential'" symbol="4" label="residential"/>
      <rule scalemaxdenom="15000" filter=" &quot;building&quot; is not null" symbol="5" scalemindenom="1" label="building">
        <rule filter="&quot;building&quot; IN ( 'church','cathedral')" symbol="6" label="church"/>
      </rule>
      <rule filter=" &quot;waterway&quot;  =  'riverbank' or  &quot;waterway&quot;  =  'stream' "/>
      <rule filter="&quot;natural&quot; = 'beach'" symbol="7"/>
      <rule filter="&quot;leisure&quot;='golf_course'" symbol="8" label="golf"/>
    </rules>
    <symbols>
      <symbol alpha="1" type="fill" name="0">
        <layer pass="0" class="ShapeburstFill" locked="0">
          <prop k="blur_radius" v="12"/>
          ...
          <prop k="shapeburst_color" v="169,201,226,255"/>
      ...
      <symbol alpha="1" type="fill" name="2">
        <layer pass="0" class="ShapeburstFill" locked="0">
          ...
          <prop k="offset_map_unit_scale" v="0,0"/>
          <prop k="offset_unit" v="MM"/>
          <prop k="shapeburst_color" v="201,223,170,255"/>
          <prop k="shapeburst_color2" v="235,255,196,255"/>
          <prop k="use_whole_shape" v="1"/>
        </layer>
      </symbol>
      ...
      <symbol alpha="1" type="fill" name="8">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="0,0"/>
          <prop k="border_width_unit" v="MM"/>
          <prop k="color" v="181,195,150,255"/>
  ...
  <customproperties>
    ...
    <property key="labeling/dataDefined/Show" value="1~~0~~~~vic_park_lab"/>
  ...
  <edittypes>
    ...
    <edittype labelontop="0" editable="1" name="statscan:rbuid"/>
    ...
    <edittype labelontop="0" editable="1" name="turn:lanes"/>
    ...
    <edittype labelontop="0" editable="1" name="mooring"/>
    ...
    <edittype labelontop="0" editable="1" name="basin"/>
    <edittype labelontop="0" editable="1" name="atm"/>
    <edittype labelontop="0" editable="1" name="building:colour"/>
    <edittype labelontop="0" editable="1" name="building:material"/>
    ...
    <edittype labelontop="0" editable="1" name="tents"/>
    <edittype labelontop="0" editable="1" name="bus"/>
    <edittype labelontop="0" editable="1" name="emergency"/>
    <edittype labelontop="0" editable="1" name="height"/>
    ...
    <edittype labelontop="0" editable="1" name="roof:shape"/>
    <edittype labelontop="0" editable="1" name="shelter_type"/>
    <edittype labelontop="0" editable="1" name="ski"/>
    <edittype labelontop="0" editable="1" name="snowmobile"/>
    <edittype labelontop="0" editable="1" name="step_count"/>
    <edittype labelontop="0" editable="1" name="supervised"/>
    <edittype labelontop="0" editable="1" name="frequency"/>
    <edittype labelontop="0" editable="1" name="trail_visibility"/>
    <edittype labelontop="0" editable="1" name="covered"/>
    <edittype labelontop="0" editable="1" name="parking:condition:area"/>
    <edittype labelontop="0" editable="1" name="surveillance"/>
    <edittype labelontop="0" editable="1" name="playground"/>
    <edittype labelontop="0" editable="1" name="shelter"/>
    <edittype labelontop="0" editable="1" name="address:full"/>
    <edittype labelontop="0" editable="1" name="bridge_name"/>
    <edittype labelontop="0" editable="1" name="brucetrail"/>
    <edittype labelontop="0" editable="1" name="building:height"/>
    <edittype labelontop="0" editable="1" name="drinking_water"/>
    <edittype labelontop="0" editable="1" name="food"/>
    <edittype labelontop="0" editable="1" name="grassland"/>
    <edittype labelontop="0" editable="1" name="school_board"/>
    <edittype labelontop="0" editable="1" name="vic_park_lab"/>
  </edittypes>
